...
export class Tab1Page {
  ...
  public contagemFoiIniciada = false;
  public pesoTotalSeparado: number;

  constructor(
    private ctrlTempo: TempoGastoService,
                  ...
                  this.file
                    ...
                    .then(value => {
                      ...
                      ped3.forEach(element => {
                        ...
                        if (corrige3[1] === '000 ') {
                          linhaCorrigida3 = corrige3[0];
                        } else {
                          const numero: any = corrige3[0] + '.' + corrige3[1];
                          linhaCorrigida3 = numero;
                        }
...

        {
          ...
          handler: async () => {
            ...
            if (contagemTerminada) {
              ...
              // função fim esta no rodape e serve para calcular tempo
              this.fimDaContagem();
              this.pesoTotalSeparado = this.calculaPeso();
              ...
              let email = {
                ...
                body:
                  "=======================================================================================" + "<br/>" +
                  "Romaneio " + this.romaneio + "<br/>" +
                  " Colaborador: " + this.usuario.nome + "  Registro: " + this.usuario.registro + "<br/><br/>" +
                  "Início da contagem: " + this.ctrlTempo.dataInicio + "<br/>" +
                  "Término da contagem : " + this.ctrlTempo.dataFim + "<br/>" +
                  "Tempo gasto em minutos: " + this.ctrlTempo.tempoGastoMinutos + "<br/>" +
                  "Peso total do separado: " + this.pesoTotalSeparado + " kg" + "<br/>" +
                  "======================================================================================= " + "<br/>" +
  ...
  public lerQr(item) {
    ...
    // inicio da contagem
    if (!this.contagemFoiIniciada) {
      this.contagemFoiIniciada = true;
      this.ctrlTempo.pegaData();
    }
                        ...
                        if (qtdClicado >= qtdDigitado) {
                          this.lista.forEach(async element => {
                            if (
                              ...
                              const pesoTotal = (valorTotalSeparado * element.peso).toFixed(2);
                              element.quantidade = valorNovo;
                              element.qtd_separada = valorTotalSeparado;
                              element.qtd_estoqueTotal = valorEstoqueNovo;
  ...
  public fimDaContagem() {
    this.contagemFoiIniciada = false;
    this.ctrlTempo.calculadata();
  }

  public zerarTempos() {
    this.ctrlTempo.dataInicio = null;
    this.contagemFoiIniciada = false;
    this.ctrlTempo.dataFim = null;
  }

  public calculaPeso() {
    const resultado = this.lista.map(item => item.pesoTotal).reduce((pesoAcumulado, proxPeso) => {
      return (parseFloat(pesoAcumulado) + parseFloat(proxPeso)).toFixed(2);
    });
    return resultado;
  }
}
